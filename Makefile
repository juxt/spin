...
test:
	...
	echo "spin-demo:<span foreground='#ff3'>TEST</span>" > /tmp/spin-demo-test-status
...
lint2:
	clj-kondo --lint src/juxt --lint test/juxt --lint examples/demo/src --lint examples/demo/test
